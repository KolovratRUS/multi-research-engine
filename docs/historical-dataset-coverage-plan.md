...
The recommended next safe phase is Phase 4Z: planning-only identification of the first real research module handoff inputs and outputs. It adds no implementation, live/API/web access, network schedule ingestion, generated run artifact, historical fixture data, or `modelProbability`.
